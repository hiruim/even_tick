...
class _EventHomeScreenState extends State<EventHomeScreen> {
  final CollectionReference eventsCollection = FirebaseFirestore.instance.collection('musical_events');
  @override
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Expanded(
              child: StreamBuilder(
                stream: FirebaseFirestore.instance.collection('musical_events').snapshots(),
